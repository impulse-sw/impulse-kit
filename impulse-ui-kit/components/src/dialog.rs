...
pub fn DialogTrigger(#[prop(into, optional)] class: String, children: Children) -> impl IntoView {
  ...
  view! {
    <button type="button" data-slot="dialog-trigger" class=class on:click=handle_click>
      {children()}
    </button>
  }
}
...
pub fn DialogClose(#[prop(into, optional)] class: String, children: Children) -> impl IntoView {
  ...
  view! {
    <button type="button" data-slot="dialog-close" class=class on:click=handle_click>
      {children()}
    </button>
  }
}
