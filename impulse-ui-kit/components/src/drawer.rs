...
pub fn DrawerOverlay(#[prop(optional, into)] class: String) -> impl IntoView {
  ...
  view! {
    <div
      ...
      class=cn(
        &[
          "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:invisible data-[state=closed]:pointer-events-none fixed inset-0 z-50 bg-black/50 data-[state=closed]:opacity-0",
          class.as_str(),
        ],
      )
      style=opacity_style
...
pub fn DrawerContent(#[prop(optional, into)] class: String, children: ChildrenFn) -> impl IntoView {
  ...
  let direction_classes = match context.direction {
    DrawerDirection::Top => {
      "inset-x-0 top-0 mb-24 max-h-[80vh] rounded-b-lg border-b data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top data-[state=closed]:h-0 data-[state=closed]:overflow-hidden"
    }
    DrawerDirection::Bottom => {
      "inset-x-0 bottom-0 mt-24 max-h-[80vh] rounded-t-lg border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom data-[state=closed]:h-0 data-[state=closed]:overflow-hidden"
    }
    DrawerDirection::Left => {
      "inset-y-0 left-0 w-3/4 border-r sm:max-w-sm data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left data-[state=closed]:w-0 data-[state=closed]:overflow-hidden"
    }
    DrawerDirection::Right => {
      "inset-y-0 right-0 w-3/4 border-l sm:max-w-sm data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right data-[state=closed]:w-0 data-[state=closed]:overflow-hidden"
    }
  };
