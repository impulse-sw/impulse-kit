...
impulse-ui-kit-components = { git = "https://github.com/impulse-sw/impulse-kit.git", tag = "1.1.0" }
leptos = "0.8"
```
...
use impulse_ui_kit_components::input::*;
use leptos::prelude::*;
...
**Example:**
```rust
use impulse_ui_kit_components::label::*;
...
**Example:**
```rust
use impulse_ui_kit_components::spinner::*;
...
**Example:**
```rust
use impulse_ui_kit_components::skeleton::*;
...
**Example:**
```rust
use impulse_ui_kit_components::badge::*;
...
**Example:**
```rust
use impulse_ui_kit_components::textarea::*;
...
**Example:**
```rust
use impulse_ui_kit_components::checkbox::*;
...
**Example:**
```rust
use impulse_ui_kit_components::switch::*;
...
**Example:**
```rust
use impulse_ui_kit_components::radio_group::*;
...
**Example:**
```rust
use impulse_ui_kit_components::select::*;
...
**Example:**
```rust
use impulse_ui_kit_components::card::*;
...
**Example:**
```rust
use impulse_ui_kit_components::separator::*;
...
**Example:**
```rust
use impulse_ui_kit_components::tabs::*;
...
**Example:**
```rust
use impulse_ui_kit_components::accordion::*;
...
**Example:**
```rust
use impulse_ui_kit_components::dialog::*;
...
**Example:**
```rust
use impulse_ui_kit_components::tooltip::*;
...
**Example:**
```rust
use impulse_ui_kit_components::alert::*;
...
**Example:**
```rust
use impulse_ui_kit_components::progress::*;
...
**Example:**
```rust
use impulse_ui_kit_components::avatar::*;
