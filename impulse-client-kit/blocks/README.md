...
```toml
[dependencies]
impulse-client-kit-blocks = { git = "https://github.com/impulse-sw/impulse-kit.git", branch = "release/1.8.x" }
leptos = "0.8"
```
...
```toml
[build-dependencies]
impulse-tailwind-sources = { git = "https://github.com/impulse-sw/impulse-kit.git", branch = "release/1.8.x" }
```
