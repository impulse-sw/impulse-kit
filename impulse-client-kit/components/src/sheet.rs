...
pub fn SheetContent(#[prop(optional, into)] class: String, children: ChildrenFn) -> impl IntoView {
  ...
  view! {
    ...
    <div
      ...
      class=cn(
        &[
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300 fixed z-50 max-h-dvh gap-4 overflow-y-auto p-6 shadow-lg data-[state=closed]:pointer-events-none data-[state=closed]:invisible",
          side_classes,
